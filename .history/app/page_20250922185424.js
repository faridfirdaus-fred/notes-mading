  ...
  return (
    <div className="min-h-screen bg-amber-800 px-4 py-8">
      <div className="container mx-auto">
        <div className="mb-8 bg-amber-900/70 p-4 rounded-t-lg shadow-lg">
          <h2 className="text-2xl font-bold text-amber-50 font-handwriting text-center">Notes Board</h2>
        </div>
