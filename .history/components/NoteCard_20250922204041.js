    ...
    >
      ...
      <div className="relative bg-opacity-90 pt-3 pb-3 px-3 overflow-hidden flex flex-col" style={{ minHeight: '300px' }}>
        ...
        <div className="px-2 flex flex-col h-full">
          ...
          <div className="mt-2 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent pr-1 flex-grow" style={{ minHeight: '60px', maxHeight: '140px' }}>
