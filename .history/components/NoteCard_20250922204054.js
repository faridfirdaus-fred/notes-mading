...
export default function NoteCard({ note }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-opacity-90 pt-3 pb-3 px-3 overflow-hidden flex flex-col" style={{ minHeight: '300px' }}>
        {/* Foto dengan margin top lebih besar agar tidak tertutup plester */}
        <div className="relative h-48 w-48 mx-auto mb-3 mt-4 flex-shrink-0">
        ...
        <div className="px-2 flex flex-col flex-grow">
          <h3 className="text-base font-bold text-gray-800 font-handwriting text-center mb-2">{note.name}</h3>
          ...
          <div className="mt-auto pt-3 flex justify-between items-center border-t border-gray-100 mt-2">
