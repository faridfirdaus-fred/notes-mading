  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <form 
        ...
        className="relative bg-yellow-50 rounded-sm overflow-hidden p-6 shadow-md transform transition-all" 
        style={{
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 font-handwriting"
            />
            {errors.name && (
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 font-handwriting text-black"
            />
            {errors.description && (
