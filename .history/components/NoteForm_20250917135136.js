        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none text-gray focus:ring-indigo-500 focus:border-indigo-500 font-handwriting"
            />
            {errors.name && (
